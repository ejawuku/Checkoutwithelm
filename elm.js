...
var $author$project$Main$confirmingPaymentView = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex items-center justify-center min-h-screen bg-gray-100 p-4')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('bg-white shadow-lg rounded-xl max-w-sm w-full')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('flex items-center justify-between border-b border-b-gray-200 mb-4')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('p-4 flex justify-between items-center w-full')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('flex items-end')
											]),
										_List_fromArray(
											[
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('border border-gray-200 w-fit rounded-md')
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$src('./src/assets/plogo.svg'),
													...
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Attributes$class('w-4 h-4 mr-1'),
																		$elm$html$Html$Attributes$src('./src/assets/check.svg'),
																		$elm$html$Html$Attributes$alt('Check Icon')
																	]),
																_List_Nil),
																$elm$html$Html$text('Verified by PaySwitch')
															]))
													]))
											])),
										A2(
							...
							[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$src('./src/assets/mastercard.svg'),
														$elm$html$Html$Attributes$alt('Wallet 1')
													]),
												_List_Nil),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$src('./src/assets/visalogo.svg'),
														$elm$html$Html$Attributes$alt('Wallet 2')
													]),
												_List_Nil)
											])) : A2(
										$elm$html$Html$div,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$src('./src/assets/at.svg'),
														$elm$html$Html$Attributes$alt('Wallet 3')
													]),
												_List_Nil),
												A2(
												$elm$html$Html$img,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$src('./src/assets/zeepay.svg'),
														$elm$html$Html$Attributes$alt('Wallet 4')
													]),
												_List_Nil),
												A2(
												$elm$html$Html$img,
												_List_fromArray(
													[
														$elm$html$Html$Attributes$src('./src/assets/gmoney.svg'),
														$elm$html$Html$Attributes$alt('Wallet 5')
													]),
												_List_Nil)
											]))
									]) : _List_Nil),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$src('./src/assets/lock.svg'),
												$elm$html$Html$Attributes$alt('Wallet 5')
											]),
										_List_Nil),
										$elm$html$Html$text('Secured by theTeller')
									]))
							]))
					]))
			]));
									...
									return A2(
										...
										function (customer_email) {
											return A2(
												...
												A2($elm$json$Json$Decode$field, 'custom_description', $elm$json$Json$Decode$string));
										},
										A2($elm$json$Json$Decode$field, 'customer_email', $elm$json$Json$Decode$string));
								},
								A2($elm$json$Json$Decode$field, 'pay_button_text', $elm$json$Json$Decode$string));
						},
						A2($elm$json$Json$Decode$field, 'payment_method', $elm$json$Json$Decode$string));
				},
				A2($elm$json$Json$Decode$field, 'redirect_url', $elm$json$Json$Decode$string));
		},
		A2($elm$json$Json$Decode$field, 'transid', $elm$json$Json$Decode$string)))(0)}});}(this));